...
while (True):
    ...
    pitch_setpoint = map_range(horizontal_stick,750,3125,MIN_ANGLE,MAX_ANGLE)
    heading_setpoint = map_range(vertical_stick,3380,1250,MIN_ANGLE,MAX_ANGLE)
    
    if (pitch_setpoint <= deadband and pitch_setpoint > 0):
        pitch_setpoint = 0
